...
A client-side lock-on targeting system for Minecraft 1.16.5 (Forge).  
...
| **Leawind's Third Person** | Camera follow mode is activated on lock; rotation targets the correct third-person camera angle; range and angle scale automatically |
...
*Created by Leolifeless — Minecraft 1.16.5 — Client-Side Only*
